...
$dbuser = "dc545";//your ucid since we follow this pattern
$dbpass = "EerosBeast007";//database password generated or chosen per respective steps
$dbdatabase = "dc545";//your ucid since we follow this pattern
?>
